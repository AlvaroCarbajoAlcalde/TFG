...
public class ConexionSQLiteHelper extends SQLiteOpenHelper {
    ...
    public static final String CREAR_TABLA_POKEMON = String.format(
            "CREATE TABLE %s(%s INTEGER PRIMARY KEY, %s TEXT NOT NULL, %s INTEGER NOT NULL, %s INTEGER, %s TEXT, %s TEXT, %s TEXT, %s TEXT)",
            NOMBRE_TABLA_POKEMON, CAMPO_POKEMON_ID, CAMPO_POKEMON_NOMBRE, CAMPO_POKEMON_TIPO_1, CAMPO_POKEMON_TIPO_2,
            CAMPO_POKEMON_DESCRIPCION, CAMPO_POKEMON_CATEGORIA, CAMPO_POKEMON_PESO, CAMPO_POKEMON_ALTURA);
